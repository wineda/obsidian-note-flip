const en = {
  ...
  cmdOpenList: "Search notes (fzf style list)",
  cmdOpenFlip: "Flip through notes (Flip 3D stack)",
  ...
  hintMove: "Move",
  untitled: "Untitled",
  listPlaceholder: "Search notes by name or contents…",
  listColName: "File name",
  listColMatch: "Match",
  listLoading: "loading…",

  settingsSourceHeading: "Notes",
  settingsStyle: "Display style",
  settingsStyleDesc:
    "List: an fzf style popup with a query box, `file name | match` rows and a preview. Flip 3D: the Aero style stack of cards.",
  styleList: "List (fzf style)",
  styleFlip: "Flip 3D",
  settingsListMax: "Notes loaded into the list",
  settingsListMaxDesc: "How many notes the list style reads and searches through.",
...
const ja: typeof en = {
  ...
  cmdOpenList: "ノートを検索 (fzf 風リスト)",
  cmdOpenFlip: "ノートをめくる (Flip 3D スタック)",
  ribbon: "ノートをめくる",
  ...
  hintMove: "移動",
  untitled: "無題",
  listPlaceholder: "ファイル名・本文で検索…",
  listColName: "ファイル名",
  listColMatch: "一致部分",
  listLoading: "読み込み中…",

  settingsSourceHeading: "ノート",
  settingsStyle: "表示スタイル",
  settingsStyleDesc:
    "リスト: fzf 風のポップアップ。入力欄、「ファイル名 | 一致部分」の一覧、プレビューを表示します。Flip 3D: Aero 風のカードスタック。",
  styleList: "リスト (fzf 風)",
  styleFlip: "Flip 3D",
  settingsListMax: "リストに読み込むノート数",
  settingsListMaxDesc: "リスト表示で読み込んで検索対象にするノートの数。",
